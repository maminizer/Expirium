...
parcelRegister("2rwrw", function(module, exports) {

$parcel$export(module.exports, "gsap", () => $1c7744dc13ad1b21$export$99ee26438460406a);

var $hhWnB = parcelRequire("hhWnB");

var $j5mEA = parcelRequire("j5mEA");
var $1c7744dc13ad1b21$export$99ee26438460406a = (0, $hhWnB.gsap).registerPlugin((0, $j5mEA.CSSPlugin)) || (0, $hhWnB.gsap), // to protect from tree shaking
$1c7744dc13ad1b21$export$7b23975ad686bf91 = $1c7744dc13ad1b21$export$99ee26438460406a.core.Tween;

});
parcelRegister("hhWnB", function(module, exports) {
...
parcelRegister("j5mEA", function(module, exports) {

$parcel$export(module.exports, "CSSPlugin", () => $de500e7c54ced7a4$export$855822f522f18eef);
/*!
 * CSSPlugin 3.12.5
 * https://gsap.com
 *
...
$de500e7c54ced7a4$var$_renderRoundedCSSProp = function _renderRoundedCSSProp(ratio, data) {
    ...
    if (property in $de500e7c54ced7a4$var$_transformProps && style) {
        this.tfm = this.tfm || {};
        if (property !== "transform") {
            ...
            }) : this.tfm[property] = cache.x ? cache[property] : $de500e7c54ced7a4$var$_get(target, property); // note: scale would map to "scaleX,scaleY", thus we loop and apply them both.
            property === $de500e7c54ced7a4$var$_transformOriginProp && (this.tfm.zOrigin = cache.zOrigin);
        } else return $de500e7c54ced7a4$var$_propertyAliases.transform.split(",").forEach(function(p) {
    ...
    props[i + 1] ? target[props[i]] = props[i + 2] : props[i + 2] ? style[props[i]] = props[i + 2] : style.removeProperty(props[i].substr(0, 2) === "--" ? props[i] : props[i].replace($de500e7c54ced7a4$var$_capsExp, "-$1").toLowerCase());
    if (this.tfm) {
        ...
        if ((!i || !i.isStart) && !style[$de500e7c54ced7a4$var$_transformProp]) {
            ...
            if (cache.zOrigin && style[$de500e7c54ced7a4$var$_transformOriginProp]) {
                style[$de500e7c54ced7a4$var$_transformOriginProp] += " " + cache.zOrigin + "px"; // since we're uncaching, we must put the zOrigin back into the transformOrigin so that we can pull it out accurately when we parse again. Otherwise, we'd lose the z portion of the origin since we extract it to protect from Safari bugs.
                cache.zOrigin = 0;
                cache.renderTransform();
            }
    ...
    target._gsap || (0, $hhWnB.gsap).core.getCache(target); // just make sure there's a _gsap cache defined because we read from it in _saveStyle() and it's more efficient to just check it here once.
    ...
    if ($de500e7c54ced7a4$var$_windowExists() && window.document) {
        ...
        $de500e7c54ced7a4$var$_reverting = (0, $hhWnB.gsap).core.reverting;
...
$de500e7c54ced7a4$var$_removeProperty = function _removeProperty(target, property) {
    if (property) {
        ...
        if (style.removeProperty) {
            ...
            property = "-" + property;
            style.removeProperty(first2Chars === "--" ? property : property.replace($de500e7c54ced7a4$var$_capsExp, "-$1").toLowerCase());
    ...
    var pt = new (0, $hhWnB.PropTween)(plugin._pt, target, property, 0, 1, onlySetAtEnd ? $de500e7c54ced7a4$var$_renderNonTweeningValueOnlyAtEnd : $de500e7c54ced7a4$var$_renderNonTweeningValue);
    plugin._pt = pt;
    pt.b = beginning;
    pt.e = end;
...
$de500e7c54ced7a4$var$_convertToUnit = function _convertToUnit(target, property, value, unit) {
    ...
    if ((toPercent || curUnit === "%") && ($de500e7c54ced7a4$var$_transformProps[property] || ~property.indexOf("adius"))) {
        ...
        return (0, $hhWnB._round)(toPercent ? curValue / px * amount : curValue / 100 * px);
    }
    ...
    cache = parent._gsap;
    if (cache && toPercent && cache.width && horizontal && cache.time === (0, $hhWnB._ticker).time && !cache.uncache) return (0, $hhWnB._round)(curValue / cache.width * amount);
    else {
        if (toPercent && (property === "height" || property === "width")) {
            ...
            v ? target.style[property] = v : $de500e7c54ced7a4$var$_removeProperty(target, property);
        } else {
        ...
        if (horizontal && toPercent) {
            cache = (0, $hhWnB._getCache)(parent);
            cache.time = (0, $hhWnB._ticker).time;
            cache.width = parent[measureProperty];
        }
    }
    return (0, $hhWnB._round)(toPixels ? px * curValue / amount : px && curValue ? amount / px * curValue : 0);
    ...
    if (!start || start === "none") {
        ...
        if (s && s !== start) {
            prop = p;
            start = s;
        } else if (prop === "borderColor") start = $de500e7c54ced7a4$var$_getComputedProperty(target, "borderTopColor"); // Firefox bug: always reports "borderColor" as "", so we must fall back to borderTopColor. See https://gsap.com/forums/topic/24583-how-to-return-colors-that-i-had-after-reverse/
    }
    var pt = new (0, $hhWnB.PropTween)(this._pt, target.style, prop, 0, 1, (0, $hhWnB._renderComplexString)), index = 0, matchIndex = 0, a, result, startValues, startNum, color, startValue, endValue, endNum, chunk, endUnit, startUnit, endValues;
    pt.b = start;
    pt.e = end;
    start += ""; // ensure values are strings
    end += "";
    if (end === "auto") {
        ...
        startValue ? target.style[prop] = startValue : $de500e7c54ced7a4$var$_removeProperty(target, prop);
    }
    a = [
        start,
        end
    ];
    (0, $hhWnB._colorStringFilter)(a); // pass an array with the starting and ending values and let the filter do whatever it needs to the values. If colors are found, it returns true and then we must match where the color shows up order-wise because for things like boxShadow, sometimes the browser provides the computed values with the color FIRST, but the user provides it with the color LAST, so flip them if necessary. Same for drop-shadow().
    start = a[0];
    end = a[1];
    startValues = start.match((0, $hhWnB._numWithUnitExp)) || [];
    endValues = end.match((0, $hhWnB._numWithUnitExp)) || [];
    if (endValues.length) {
        while(result = (0, $hhWnB._numWithUnitExp).exec(end)){
            endValue = result[0];
            chunk = end.substring(index, result.index);
            if (color) color = (color + 1) % 5;
            ...
            if (endValue !== (startValue = startValues[matchIndex++] || "")) {
                ...
                endValue.charAt(1) === "=" && (endValue = (0, $hhWnB._parseRelative)(startNum, endValue) + startUnit);
                endNum = parseFloat(endValue);
                endUnit = endValue.substr((endNum + "").length);
                index = (0, $hhWnB._numWithUnitExp).lastIndex - endUnit.length;
                if (!endUnit) {
                    //if something like "perspective:300" is passed in and we must add a unit to the end
                    endUnit = endUnit || (0, $hhWnB._config).units[prop] || startUnit;
                    if (index === end.length) {
                        end += endUnit;
                        pt.e += endUnit;
                    }
    ...
    (0, $hhWnB._relExp).test(end) && (pt.e = 0); //if the end string contains relative values or dynamic random(...) values, delete the end it so that on the final render we don't actually set it to the string with += or -= characters (forces it to use the calculated value).
...
$de500e7c54ced7a4$var$_specialProps = {
    clearProps: function clearProps(plugin, target, property, endValue, tween) {
        if (tween.data !== "isFromStart") {
            var pt = plugin._pt = new (0, $hhWnB.PropTween)(plugin._pt, target, property, 0, 0, $de500e7c54ced7a4$var$_renderClearProps);
            pt.u = endValue;
            pt.pr = -10;
            pt.tween = tween;
            plugin._props.push(property);
 ...
 */ $de500e7c54ced7a4$var$_identity2DMatrix = [
    ...
    return $de500e7c54ced7a4$var$_isNullTransform(matrixString) ? $de500e7c54ced7a4$var$_identity2DMatrix : matrixString.substr(7).match((0, $hhWnB._numExp)).map((0, $hhWnB._round));
}, $de500e7c54ced7a4$var$_getMatrix = function _getMatrix(target, force2D) {
    var cache = target._gsap || (0, $hhWnB._getCache)(target), style = target.style, matrix = $de500e7c54ced7a4$var$_getComputedTransformMatrixAsArray(target), parent, nextSibling, temp, addedToDOM;
    ...
    var cache = target._gsap || new (0, $hhWnB.GSCache)(target);
    ...
    if (matrix !== $de500e7c54ced7a4$var$_identity2DMatrix) {
        ...
        if (matrix.length === 6) {
            ...
            scaleX = (0, $hhWnB._round)(Math.sqrt(a * a + b * b + c * c));
            scaleY = (0, $hhWnB._round)(Math.sqrt(a22 * a22 + a32 * a32));
    ...
    cache.z = z + px;
    cache.scaleX = (0, $hhWnB._round)(scaleX);
    cache.scaleY = (0, $hhWnB._round)(scaleY);
    cache.rotation = (0, $hhWnB._round)(rotation) + deg;
    cache.rotationX = (0, $hhWnB._round)(rotationX) + deg;
    cache.rotationY = (0, $hhWnB._round)(rotationY) + deg;
    cache.skewX = skewX + deg;
    cache.skewY = skewY + deg;
    cache.transformPerspective = perspective + px;
    if (cache.zOrigin = parseFloat(origin.split(" ")[2]) || !uncache && cache.zOrigin || 0) style[$de500e7c54ced7a4$var$_transformOriginProp] = $de500e7c54ced7a4$var$_firstTwoOnly(origin);
    cache.xOffset = cache.yOffset = 0;
    cache.force3D = (0, $hhWnB._config).force3D;
...
$de500e7c54ced7a4$var$_addPxTranslate = function _addPxTranslate(target, start, value) {
    var unit = (0, $hhWnB.getUnit)(start);
    return (0, $hhWnB._round)(parseFloat(start) + parseFloat($de500e7c54ced7a4$var$_convertToUnit(target, "x", value + "px", unit))) + unit;
    ...
    if (rotation || skewX) {
        ...
        a11 = (0, $hhWnB._round)(a11);
        a21 = (0, $hhWnB._round)(a21);
        a12 = (0, $hhWnB._round)(a12);
        a22 = (0, $hhWnB._round)(a22);
    } else {
        a11 = scaleX;
        a22 = scaleY;
        a21 = a12 = 0;
    ...
    if (xOrigin || yOrigin || xOffset || yOffset) {
        tx = (0, $hhWnB._round)(tx + xOrigin - (xOrigin * a11 + yOrigin * a12) + xOffset);
        ty = (0, $hhWnB._round)(ty + yOrigin - (xOrigin * a21 + yOrigin * a22) + yOffset);
    }
    if (xPercent || yPercent) {
        //The SVG spec doesn't support percentage-based translation in the "transform" attribute, so we merge it into the translation to simulate it.
        temp = target.getBBox();
        tx = (0, $hhWnB._round)(tx + xPercent / 100 * temp.width);
        ty = (0, $hhWnB._round)(ty + yPercent / 100 * temp.height);
    }
    ...
    var cap = 360, isString = (0, $hhWnB._isString)(endValue), endNum = parseFloat(endValue) * (isString && ~endValue.indexOf("rad") ? $de500e7c54ced7a4$var$_RAD2DEG : 1), change = endNum - startNum, finalValue = startNum + change + "deg", direction, pt;
    if (isString) {
    ...
    plugin._pt = pt = new (0, $hhWnB.PropTween)(plugin._pt, target, property, startNum, change, $de500e7c54ced7a4$var$_renderPropWithEnd);
    pt.e = finalValue;
    pt.u = "deg";
    plugin._props.push(property);
    return pt;
    ...
    for(p in $de500e7c54ced7a4$var$_transformProps){
        ...
        if (startValue !== endValue && exclude.indexOf(p) < 0) {
            ...
            startUnit = (0, $hhWnB.getUnit)(startValue);
            endUnit = (0, $hhWnB.getUnit)(endValue);
            startNum = startUnit !== endUnit ? $de500e7c54ced7a4$var$_convertToUnit(target, p, startValue, endUnit) : parseFloat(startValue);
            endNum = parseFloat(endValue);
            plugin._pt = new (0, $hhWnB.PropTween)(plugin._pt, endCache, p, startNum, endNum - startNum, $de500e7c54ced7a4$var$_renderCSSProp);
...
(0, $hhWnB._forEachName)("padding,margin,Width,Radius", function(name, index) {
...
var $de500e7c54ced7a4$export$855822f522f18eef = {
    ...
    init: function init(target, vars, tween, index, targets) {
        ...
        for(p in vars){
            ...
            endValue = vars[p];
            if ((0, $hhWnB._plugins)[p] && (0, $hhWnB._checkPlugin)(p, vars, tween, index, target, targets)) continue;
            ...
            if (type === "string" && ~endValue.indexOf("random(")) endValue = (0, $hhWnB._replaceRandom)(endValue);
            if (specialProp) specialProp(this, target, p, endValue, tween) && (hasPriority = 1);
            else if (p.substr(0, 2) === "--") {
                //CSS variable
                startValue = (getComputedStyle(target).getPropertyValue(p) + "").trim();
                endValue += "";
                (0, $hhWnB._colorExp).lastIndex = 0;
                if (!(0, $hhWnB._colorExp).test(startValue)) {
                ...
                if (startAt && p in startAt) {
                    ...
                    (0, $hhWnB._isString)(startValue) && ~startValue.indexOf("random(") && (startValue = (0, $hhWnB._replaceRandom)(startValue));
                    (0, $hhWnB.getUnit)(startValue + "") || startValue === "auto" || (startValue += (0, $hhWnB._config).units[p] || (0, $hhWnB.getUnit)($de500e7c54ced7a4$var$_get(target, p)) || ""); // for cases when someone passes in a unitless value like {x: 100}; if we try setting translate(100, 0px) it won't work.
                ...
                if (isTransformRelated) {
                    ...
                    if (!transformPropTween) {
                        ...
                        transformPropTween = this._pt = new (0, $hhWnB.PropTween)(this._pt, style, $de500e7c54ced7a4$var$_transformProp, 0, 1, cache.renderTransform, cache, 0, -1); //the first time through, create the rendering PropTween so that it runs LAST (in the linked list, we keep adding to the beginning)
                        transformPropTween.dep = 1; //flag it as dependent so that if things get killed/overwritten and this is the only PropTween left, we can safely kill the whole tween.
                    }
                    if (p === "scale") {
                        this._pt = new (0, $hhWnB.PropTween)(this._pt, cache, "scaleY", cache.scaleY, (relative ? (0, $hhWnB._parseRelative)(cache.scaleY, relative + endNum) : endNum) - cache.scaleY || 0, $de500e7c54ced7a4$var$_renderCSSProp);
                        this._pt.u = 0;
                        props.push("scaleY", p);
                        p += "X";
                        ...
                        $de500e7c54ced7a4$var$_addRotationalPropTween(this, cache, p, startNum, relative ? (0, $hhWnB._parseRelative)(startNum, relative + endValue) : endValue);
                        continue;
                ...
                if (isTransformRelated || (endNum || endNum === 0) && (startNum || startNum === 0) && !$de500e7c54ced7a4$var$_complexExp.test(endValue) && p in style) {
                    ...
                    endUnit = (0, $hhWnB.getUnit)(endValue) || (p in (0, $hhWnB._config).units ? (0, $hhWnB._config).units[p] : startUnit);
                    startUnit !== endUnit && (startNum = $de500e7c54ced7a4$var$_convertToUnit(target, p, startValue, endUnit));
                    this._pt = new (0, $hhWnB.PropTween)(this._pt, isTransformRelated ? cache : style, p, startNum, (relative ? (0, $hhWnB._parseRelative)(startNum, relative + endNum) : endNum) - startNum, !isTransformRelated && (endUnit === "px" || p === "zIndex") && vars.autoRound !== false ? $de500e7c54ced7a4$var$_renderRoundedCSSProp : $de500e7c54ced7a4$var$_renderCSSProp);
                    ...
                    this.add(target, p, startValue || target[p], relative ? relative + endValue : endValue, index, targets);
                        ...
                        (0, $hhWnB._missingPlugin)(p, endValue);
                        continue;
                    }
        ...
        hasPriority && (0, $hhWnB._sortPropTweensByPriority)(this);
    },
    render: function render(ratio, data) {
...
(0, $hhWnB.gsap).utils.checkPrefix = $de500e7c54ced7a4$export$8cbef5dd49a09c8b;
(0, $hhWnB.gsap).core.getStyleSaver = $de500e7c54ced7a4$var$_getStyleSaver;
(function(positionAndScale, rotation, others, aliases) {
    var all = (0, $hhWnB._forEachName)(positionAndScale + "," + rotation + "," + others, function(name) {
        $de500e7c54ced7a4$var$_transformProps[name] = 1;
    });
    (0, $hhWnB._forEachName)(rotation, function(name) {
        (0, $hhWnB._config).units[name] = "deg";
        $de500e7c54ced7a4$var$_rotationalProperties[name] = 1;
    });
    $de500e7c54ced7a4$var$_propertyAliases[all[13]] = positionAndScale + "," + rotation;
    (0, $hhWnB._forEachName)(aliases, function(name) {
        var split = name.split(":");
        $de500e7c54ced7a4$var$_propertyAliases[split[1]] = all[split[0]];
    });
})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent", "rotation,rotationX,rotationY,skewX,skewY", "transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective", "0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");
(0, $hhWnB._forEachName)("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective", function(name) {
    (0, $hhWnB._config).units[name] = "px";
});
(0, $hhWnB.gsap).registerPlugin($de500e7c54ced7a4$export$855822f522f18eef);

});


parcelRegister("4KH4f", function(module, exports) {

$parcel$export(module.exports, "ScrollTrigger", () => $375cdd9a1f4cd44d$export$875bcbe48555930);
/*!
...
$375cdd9a1f4cd44d$var$_pointerDownHandler = function _pointerDownHandler() {
...
}, $375cdd9a1f4cd44d$var$_getViewportDimension = function _getViewportDimension(dimensionProperty) {
    return (dimensionProperty === "Height" ? $375cdd9a1f4cd44d$var$_100vh : $375cdd9a1f4cd44d$var$_win["inner" + dimensionProperty]) || $375cdd9a1f4cd44d$var$_docEl["client" + dimensionProperty] || $375cdd9a1f4cd44d$var$_body["client" + dimensionProperty];
}, $375cdd9a1f4cd44d$var$_getBoundsFunc = function _getBoundsFunc(element) {
    return (0, $1i8wn._getProxyProp)(element, "getBoundingClientRect") || ($375cdd9a1f4cd44d$var$_isViewport(element) ? function() {
        $375cdd9a1f4cd44d$var$_winOffsets.width = $375cdd9a1f4cd44d$var$_win.innerWidth;
        $375cdd9a1f4cd44d$var$_winOffsets.height = $375cdd9a1f4cd44d$var$_100vh;
    ...
    return (a = (0, $1i8wn._getProxyProp)(scroller, "getBoundingClientRect")) ? function() {
        return a()[d];
    } : function() {
        return (isViewport ? $375cdd9a1f4cd44d$var$_getViewportDimension(d2) : scroller["client" + d2]) || 0;
    };
}, $375cdd9a1f4cd44d$var$_getOffsetsFunc = function _getOffsetsFunc(element, isViewport) {
    return !isViewport || ~(0, $1i8wn._proxies).indexOf(element) ? $375cdd9a1f4cd44d$var$_getBoundsFunc(element) : function() {
        return $375cdd9a1f4cd44d$var$_winOffsets;
    };
}, $375cdd9a1f4cd44d$var$_maxScroll = function _maxScroll(element, _ref2) {
    var s = _ref2.s, d2 = _ref2.d2, d = _ref2.d, a = _ref2.a;
    return Math.max(0, (s = "scroll" + d2, a = (0, $1i8wn._getProxyProp)(element, s)) ? a() - $375cdd9a1f4cd44d$var$_getBoundsFunc(element)()[d] : $375cdd9a1f4cd44d$var$_isViewport(element) ? ($375cdd9a1f4cd44d$var$_docEl[s] || $375cdd9a1f4cd44d$var$_body[s]) - $375cdd9a1f4cd44d$var$_getViewportDimension(d2) : element[s] - element["offset" + d2]);
    ...
    var e = $375cdd9a1f4cd44d$var$_doc.createElement("div"), useFixedPosition = $375cdd9a1f4cd44d$var$_isViewport(container) || (0, $1i8wn._getProxyProp)(container, "pinType") === "fixed", isScroller = type.indexOf("scroller") !== -1, parent = useFixedPosition ? $375cdd9a1f4cd44d$var$_body : container, isStart = type.indexOf("start") !== -1, color = isStart ? startColor : endColor, css = "border-color:" + color + ";font-size:" + fontSize + ";color:" + color + ";font-weight:" + fontWeight + ";pointer-events:none;white-space:nowrap;font-family:sans-serif,Arial;z-index:1000;padding:4px 8px;border-width:0;border-style:solid;";
    css += "position:" + ((isScroller || containerAnimation) && useFixedPosition ? "fixed;" : "absolute;");
    (isScroller || containerAnimation || !useFixedPosition) && (css += (direction === (0, $1i8wn._vertical) ? $375cdd9a1f4cd44d$var$_right : $375cdd9a1f4cd44d$var$_bottom) + ":" + (offset + parseFloat(indent)) + "px;");
...
$375cdd9a1f4cd44d$var$_revertRecorded = function _revertRecorded(media) {
    ...
    $375cdd9a1f4cd44d$var$_isReverted = true;
    ...
    (0, $1i8wn._scrollers).cache++;
    (force || !$375cdd9a1f4cd44d$var$_refreshingAll) && (0, $1i8wn._scrollers).forEach(function(obj) {
...
}, $375cdd9a1f4cd44d$var$_refresh100vh = function _refresh100vh() {
    $375cdd9a1f4cd44d$var$_body.appendChild($375cdd9a1f4cd44d$var$_div100vh);
    $375cdd9a1f4cd44d$var$_100vh = !$375cdd9a1f4cd44d$var$_normalizer && $375cdd9a1f4cd44d$var$_div100vh.offsetHeight || $375cdd9a1f4cd44d$var$_win.innerHeight;
    $375cdd9a1f4cd44d$var$_body.removeChild($375cdd9a1f4cd44d$var$_div100vh);
}, $375cdd9a1f4cd44d$var$_hideAllMarkers = function _hideAllMarkers(hide) {
    return $375cdd9a1f4cd44d$var$_toArray(".gsap-marker-start, .gsap-marker-end, .gsap-marker-scroller-start, .gsap-marker-scroller-end").forEach(function(el) {
        return el.style.display = hide ? "none" : "block";
    });
}, $375cdd9a1f4cd44d$var$_refreshAll = function _refreshAll(force, skipRevert) {
    if ($375cdd9a1f4cd44d$var$_lastScrollTime && !force && !$375cdd9a1f4cd44d$var$_isReverted) {
        $375cdd9a1f4cd44d$var$_addListener($375cdd9a1f4cd44d$export$875bcbe48555930, "scrollEnd", $375cdd9a1f4cd44d$var$_softRefresh);
        return;
    }
    $375cdd9a1f4cd44d$var$_refresh100vh();
    $375cdd9a1f4cd44d$var$_refreshingAll = $375cdd9a1f4cd44d$export$875bcbe48555930.isRefreshing = true;
    (0, $1i8wn._scrollers).forEach(function(obj) {
    ...
    $375cdd9a1f4cd44d$var$_isReverted = false;
    ...
    $375cdd9a1f4cd44d$var$_clampingMax = 1; // pinSpacing might be propping a page open, thus when we .setPositions() to clamp a ScrollTrigger's end we should leave the pinSpacing alone. That's what this flag is for.
    $375cdd9a1f4cd44d$var$_hideAllMarkers(true);
    $375cdd9a1f4cd44d$var$_triggers.forEach(function(t) {
        // the scroller's max scroll position may change after all the ScrollTriggers refreshed (like pinning could push it down), so we need to loop back and correct any with end: "max". Same for anything with a clamped end
        var max = $375cdd9a1f4cd44d$var$_maxScroll(t.scroller, t._dir), endClamp = t.vars.end === "max" || t._endClamp && t.end > max, startClamp = t._startClamp && t.start >= max;
        (endClamp || startClamp) && t.setPositions(startClamp ? max - 1 : t.start, endClamp ? Math.max(startClamp ? max : t.start + 1, max) : t.end, true);
    });
    $375cdd9a1f4cd44d$var$_hideAllMarkers(false);
    $375cdd9a1f4cd44d$var$_clampingMax = 0;
    ...
    $375cdd9a1f4cd44d$var$_refreshingAll = 2;
    ...
    if (force === 2 || !$375cdd9a1f4cd44d$var$_refreshingAll && !$375cdd9a1f4cd44d$var$_isReverted) {
        ...
        $375cdd9a1f4cd44d$var$_refreshingAll || ($375cdd9a1f4cd44d$var$_lastScroll = scroll);
        if (recordVelocity) {
    ...
    if (!pin._gsap.swappedIn) {
        ...
        spacerStyle[$375cdd9a1f4cd44d$var$_width] = $375cdd9a1f4cd44d$var$_getSize(pin, (0, $1i8wn._horizontal)) + $375cdd9a1f4cd44d$var$_px;
        spacerStyle[$375cdd9a1f4cd44d$var$_height] = $375cdd9a1f4cd44d$var$_getSize(pin, (0, $1i8wn._vertical)) + $375cdd9a1f4cd44d$var$_px;
...
// },
$375cdd9a1f4cd44d$var$_parsePosition = function _parsePosition(value, trigger, scrollerSize, direction, scroll, marker, markerScroller, self, scrollerBounds, borderWidth, useFixedPosition, scrollerMax, containerAnimation, clampZeroProp) {
    ...
    if (!$375cdd9a1f4cd44d$var$_isNumber(value)) {
        ...
        element = (0, $1i8wn._getTarget)(trigger, self) || $375cdd9a1f4cd44d$var$_body;
        ...
        containerAnimation && (value = $375cdd9a1f4cd44d$var$gsap.utils.mapRange(containerAnimation.scrollTrigger.start, containerAnimation.scrollTrigger.end, 0, scrollerMax, value));
        markerScroller && $375cdd9a1f4cd44d$var$_positionMarker(markerScroller, scrollerSize, direction, true);
    }
    if (clampZeroProp) {
...
}, $375cdd9a1f4cd44d$var$_interruptionTracker = function _interruptionTracker(getValueFunc, initialValue, onInterrupt) {
...
}, $375cdd9a1f4cd44d$var$_shiftMarker = function _shiftMarker(marker, direction, value) {
    var vars = {};
...
$375cdd9a1f4cd44d$var$_getTweenCreator = function _getTweenCreator(scroller, direction) {
    var getScroll = (0, $1i8wn._getScrollFunc)(scroller, direction), prop = "_scroll" + direction.p2, // add a tweenable property to the scroller that's a getter/setter function, like _scrollTop or _scrollLeft. This way, if someone does gsap.killTweensOf(scroller) it'll kill the scroll tween.
    getTween = function getTween(scrollTo, vars, initialValue, change1, change2) {
        var tween = getTween.tween, onComplete = vars.onComplete, modifiers = {};
        initialValue = initialValue || getScroll();
        var checkForInterruption = $375cdd9a1f4cd44d$var$_interruptionTracker(getScroll, initialValue, function() {
            tween.kill();
            getTween.tween = 0;
        });
        ...
        vars.onUpdate = function() {
            (0, $1i8wn._scrollers).cache++;
            getTween.tween && $375cdd9a1f4cd44d$var$_updateAll(); // if it was interrupted/killed, like in a context.revert(), don't force an updateAll()
        };
    ...
    $375cdd9a1f4cd44d$export$875bcbe48555930.isTouch && $375cdd9a1f4cd44d$var$_addListener(scroller, "touchmove", getScroll.wheelHandler);
    return getTween;
};
var $375cdd9a1f4cd44d$export$875bcbe48555930 = /*#__PURE__*/ function() {
    function ScrollTrigger(vars, animation) {
        ...
        $375cdd9a1f4cd44d$var$_context(this);
    ...
    _proto.init = function init(vars, animation) {
        ...
        var _vars = vars, onUpdate = _vars.onUpdate, toggleClass = _vars.toggleClass, id = _vars.id, onToggle = _vars.onToggle, onRefresh = _vars.onRefresh, scrub = _vars.scrub, trigger = _vars.trigger, pin = _vars.pin, pinSpacing = _vars.pinSpacing, invalidateOnRefresh = _vars.invalidateOnRefresh, anticipatePin = _vars.anticipatePin, onScrubComplete = _vars.onScrubComplete, onSnapComplete = _vars.onSnapComplete, once = _vars.once, snap = _vars.snap, pinReparent = _vars.pinReparent, pinSpacer = _vars.pinSpacer, containerAnimation = _vars.containerAnimation, fastScrollEnd = _vars.fastScrollEnd, preventOverlaps = _vars.preventOverlaps, direction = vars.horizontal || vars.containerAnimation && vars.horizontal !== false ? (0, $1i8wn._horizontal) : (0, $1i8wn._vertical), isToggle = !scrub && scrub !== 0, scroller = (0, $1i8wn._getTarget)(vars.scroller || $375cdd9a1f4cd44d$var$_win), scrollerCache = $375cdd9a1f4cd44d$var$gsap.core.getCache(scroller), isViewport = $375cdd9a1f4cd44d$var$_isViewport(scroller), useFixedPosition = ("pinType" in vars ? vars.pinType : (0, $1i8wn._getProxyProp)(scroller, "pinType") || isViewport && "fixed") === "fixed", callbacks = [
            vars.onEnter,
            vars.onLeave,
            vars.onEnterBack,
            vars.onLeaveBack
        ...
        }, getScrollerSize = $375cdd9a1f4cd44d$var$_getSizeFunc(scroller, isViewport, direction), getScrollerOffsets = $375cdd9a1f4cd44d$var$_getOffsetsFunc(scroller, isViewport), lastSnap = 0, lastRefresh = 0, prevProgress = 0, scrollFunc = (0, $1i8wn._getScrollFunc)(scroller, direction), tweenTo, pinCache, snapFunc, scroll1, scroll2, start, end, markerStart, markerEnd, markerStartTrigger, markerEndTrigger, markerVars, executingOnRefresh, change, pinOriginalState, pinActiveState, pinState, spacer, offset, pinGetter, pinSetter, pinStart, pinChange, spacingStart, spacerState, markerStartSetter, pinMoves, markerEndSetter, cs, snap1, snap2, scrubTween, scrubSmooth, snapDurClamp, snapDelayedCall, prevScroll, prevAnimProgress, caMarkerSetter, customRevertReturn; // for the sake of efficiency, _startClamp/_endClamp serve like a truthy value indicating that clamping was enabled on the start/end, and ALSO store the actual pre-clamped numeric value. We tap into that in ScrollSmoother for speed effects. So for example, if start="clamp(top bottom)" results in a start of -100 naturally, it would get clamped to 0 but -100 would be stored in _startClamp.
        ...
        scrollerCache.tweenScroll = scrollerCache.tweenScroll || {
            top: $375cdd9a1f4cd44d$var$_getTweenCreator(scroller, (0, $1i8wn._vertical)),
            left: $375cdd9a1f4cd44d$var$_getTweenCreator(scroller, (0, $1i8wn._horizontal))
        };
        ...
        if (snap) {
            ...
            (0, $1i8wn._scrollers).forEach(function(o) {
            ...
            snapDelayedCall = $375cdd9a1f4cd44d$var$gsap.delayedCall(snap.delay || scrubSmooth / 2 || 0.1, function() {
                ...
                if ((refreshedRecently || Math.abs(self.getVelocity()) < 10) && !tween && !$375cdd9a1f4cd44d$var$_pointerIsDown && lastSnap !== scroll) {
                    ...
                    $375cdd9a1f4cd44d$var$_isNumber(endValue) || (endValue = naturalEnd); // in case the function didn't return a number, fall back to using the naturalEnd
        ...
        trigger = self.trigger = (0, $1i8wn._getTarget)(trigger || pin !== true && pin); // if a trigger has some kind of scroll-related effect applied that could contaminate the "y" or "x" position (like a ScrollSmoother effect), we needed a way to temporarily revert it, so we use the stRevert property of the gsCache. It can return another function that we'll call at the end so it can return to its normal state.
        customRevertReturn = trigger && trigger._gsap && trigger._gsap.stRevert;
        customRevertReturn && (customRevertReturn = customRevertReturn(self));
        pin = pin === true ? trigger : (0, $1i8wn._getTarget)(pin);
        ...
        if (pin) {
            ...
            if (!pinCache.spacer) {
                ...
                if (pinSpacer) {
                    pinSpacer = (0, $1i8wn._getTarget)(pinSpacer);
        ...
        if (markers) {
            ...
            var content = (0, $1i8wn._getTarget)((0, $1i8wn._getProxyProp)(scroller, "content") || scroller);
            ...
            if (!useFixedPosition && !((0, $1i8wn._proxies).length && (0, $1i8wn._getProxyProp)(scroller, "fixedMarkers") === true)) {
        ...
        self.revert = function(revert, temp) {
            ...
            if (r !== self.isReverted) {
                ...
                if (r) {
                    $375cdd9a1f4cd44d$var$_refreshing = self;
                    self.update(r); // make sure the pin is back in its original position so that all the measurements are correct. do this BEFORE swapping the pin out
                }
                if (pin && (!pinReparent || !self.isActive)) {
                    if (r) $375cdd9a1f4cd44d$var$_swapPinOut(pin, spacer, pinOriginalState);
                    else $375cdd9a1f4cd44d$var$_swapPinIn(pin, spacer, $375cdd9a1f4cd44d$var$_getComputedStyle(pin), spacerState);
                }
        ...
        self.refresh = function(soft, force, position, pinOffset) {
            ...
            var size = getScrollerSize(), scrollerBounds = getScrollerOffsets(), max = containerAnimation ? containerAnimation.duration() : $375cdd9a1f4cd44d$var$_maxScroll(scroller, direction), isFirstRefresh = change <= 0.01, offset = 0, otherPinOffset = pinOffset || 0, parsedEnd = $375cdd9a1f4cd44d$var$_isObject(position) ? position.end : vars.end, parsedEndTrigger = vars.endTrigger || trigger, parsedStart = $375cdd9a1f4cd44d$var$_isObject(position) ? position.start : vars.start || (vars.start === 0 || !trigger ? 0 : pin ? "0 0" : "0 100%"), pinnedContainer = self.pinnedContainer = vars.pinnedContainer && (0, $1i8wn._getTarget)(vars.pinnedContainer, self), triggerIndex = trigger && Math.max(0, $375cdd9a1f4cd44d$var$_triggers.indexOf(self)) || 0, i = triggerIndex, cs, bounds, scroll, isVertical, override, curTrigger, curPin, oppositeScroll, initted, revertedPins, forcedOverflow, markerStartOffset, markerEndOffset;
            if (markers && $375cdd9a1f4cd44d$var$_isObject(position)) {
                // if we alter the start/end positions with .setPositions(), it generally feeds in absolute NUMBERS which don't convey information about where to line up the markers, so to keep it intuitive, we record how far the trigger positions shift after applying the new numbers and then offset by that much in the opposite direction. We do the same to the associated trigger markers too of course.
                markerStartOffset = $375cdd9a1f4cd44d$var$gsap.getProperty(markerStartTrigger, direction.p);
                markerEndOffset = $375cdd9a1f4cd44d$var$gsap.getProperty(markerEndTrigger, direction.p);
            }
            while(i--){
                // user might try to pin the same element more than once, so we must find any prior triggers with the same pin, revert them, and determine how long they're pinning so that we can offset things appropriately. Make sure we revert from last to first so that things "rewind" properly.
                curTrigger = $375cdd9a1f4cd44d$var$_triggers[i];
                curTrigger.end || curTrigger.refresh(0, 1) || ($375cdd9a1f4cd44d$var$_refreshing = self); // if it's a timeline-based trigger that hasn't been fully initialized yet because it's waiting for 1 tick, just force the refresh() here, otherwise if it contains a pin that's supposed to affect other ScrollTriggers further down the page, they won't be adjusted properly.
            ...
            parsedStart = $375cdd9a1f4cd44d$var$_parseClamp(parsedStart, "start", self);
            start = $375cdd9a1f4cd44d$var$_parsePosition(parsedStart, trigger, size, direction, scrollFunc(), markerStart, markerStartTrigger, self, scrollerBounds, borderWidth, useFixedPosition, max, containerAnimation, self._startClamp && "_startClamp") || (pin ? -0.001 : 0);
            ...
            if ($375cdd9a1f4cd44d$var$_isString(parsedEnd) && !parsedEnd.indexOf("+=")) {
                if (~parsedEnd.indexOf(" ")) parsedEnd = ($375cdd9a1f4cd44d$var$_isString(parsedStart) ? parsedStart.split(" ")[0] : "") + parsedEnd;
                    ...
                    parsedEnd = $375cdd9a1f4cd44d$var$_isString(parsedStart) ? parsedStart : (containerAnimation ? $375cdd9a1f4cd44d$var$gsap.utils.mapRange(0, containerAnimation.duration(), containerAnimation.scrollTrigger.start, containerAnimation.scrollTrigger.end, start) : start) + offset; // _parsePosition won't factor in the offset if the start is a number, so do it here.
                    parsedEndTrigger = trigger;
                }
            }
            parsedEnd = $375cdd9a1f4cd44d$var$_parseClamp(parsedEnd, "end", self);
            end = Math.max(start, $375cdd9a1f4cd44d$var$_parsePosition(parsedEnd || (parsedEndTrigger ? "100% 0" : max), parsedEndTrigger, size, direction, scrollFunc() + offset, markerEnd, markerEndTrigger, self, scrollerBounds, borderWidth, useFixedPosition, max, containerAnimation, self._endClamp && "_endClamp")) || -0.001;
            offset = 0;
            i = triggerIndex;
            while(i--){
                curTrigger = $375cdd9a1f4cd44d$var$_triggers[i];
            ...
            if (self._endClamp && !$375cdd9a1f4cd44d$var$_refreshingAll) {
                self._endClamp = end || -0.001;
                end = Math.min(end, $375cdd9a1f4cd44d$var$_maxScroll(scroller, direction));
            }
            ...
            prevProgress = $375cdd9a1f4cd44d$var$gsap.utils.clamp(0, 1, $375cdd9a1f4cd44d$var$gsap.utils.normalize(start, end, prevScroll));
            ...
            if (pin && !($375cdd9a1f4cd44d$var$_clampingMax && self.end >= $375cdd9a1f4cd44d$var$_maxScroll(scroller, direction))) {
                cs = $375cdd9a1f4cd44d$var$_getComputedStyle(pin);
                isVertical = direction === (0, $1i8wn._vertical);
                scroll = scrollFunc(); // recalculate because the triggers can affect the scroll
                pinStart = parseFloat(pinGetter(direction.a)) + otherPinOffset;
                if (!max && end > 1) {
                    // makes sure the scroller has a scrollbar, otherwise if something has width: 100%, for example, it would be too big (exclude the scrollbar). See https://gsap.com/forums/topic/25182-scrolltrigger-width-of-page-increase-where-markers-are-set-to-false/
                    forcedOverflow = (isViewport ? $375cdd9a1f4cd44d$var$_doc.scrollingElement || $375cdd9a1f4cd44d$var$_docEl : scroller).style;
                    forcedOverflow = {
                        style: forcedOverflow,
                        value: forcedOverflow["overflow" + direction.a.toUpperCase()]
                    };
                    if (isViewport && $375cdd9a1f4cd44d$var$_getComputedStyle($375cdd9a1f4cd44d$var$_body)["overflow" + direction.a.toUpperCase()] !== "scroll") // avoid an extra scrollbar if BOTH <html> and <body> have overflow set to "scroll"
                ...
                oppositeScroll = useFixedPosition && (0, $1i8wn._getScrollFunc)(scroller, isVertical ? (0, $1i8wn._horizontal) : (0, $1i8wn._vertical))();
                if (pinSpacing) {
                    spacerState = [
                    ...
                    if (i) {
                        spacerState.push(direction.d, i + $375cdd9a1f4cd44d$var$_px); // for box-sizing: border-box (must include padding).
                        spacer.style.flexBasis !== "auto" && (spacer.style.flexBasis = i + $375cdd9a1f4cd44d$var$_px);
                    }
                    $375cdd9a1f4cd44d$var$_setState(spacerState);
                    ...
                    i = $375cdd9a1f4cd44d$var$_getSize(pin, direction);
                    i && spacer.style.flexBasis !== "auto" && (spacer.style.flexBasis = i + $375cdd9a1f4cd44d$var$_px);
                }
                if (useFixedPosition) {
                    override = {
            ...
            if (isFirstRefresh || prevProgress !== self.progress || containerAnimation || invalidateOnRefresh) {
                ...
                animation && !isToggle && animation.totalProgress(containerAnimation && start < -0.001 && !prevProgress ? $375cdd9a1f4cd44d$var$gsap.utils.normalize(start, end, 0) : prevProgress, true); // to avoid issues where animation callbacks like onStart aren't triggered.
            ...
            if (!isNaN(markerStartOffset)) {
                ...
                markerStartOffset -= $375cdd9a1f4cd44d$var$gsap.getProperty(markerStartTrigger, direction.p);
                markerEndOffset -= $375cdd9a1f4cd44d$var$gsap.getProperty(markerEndTrigger, direction.p);
                $375cdd9a1f4cd44d$var$_shiftMarker(markerStartTrigger, direction, markerStartOffset);
                $375cdd9a1f4cd44d$var$_shiftMarker(markerStart, direction, markerStartOffset - (pinOffset || 0));
                $375cdd9a1f4cd44d$var$_shiftMarker(markerEndTrigger, direction, markerEndOffset);
                $375cdd9a1f4cd44d$var$_shiftMarker(markerEnd, direction, markerEndOffset - (pinOffset || 0));
            }
            isFirstRefresh && !$375cdd9a1f4cd44d$var$_refreshingAll && self.update(); // edge case - when you reload a page when it's already scrolled down, some browsers fire a "scroll" event before DOMContentLoaded, triggering an updateAll(). If we don't update the self.progress as part of refresh(), then when it happens next, it may record prevProgress as 0 when it really shouldn't, potentially causing a callback in an animation to fire again.
            if (onRefresh && !$375cdd9a1f4cd44d$var$_refreshingAll && !executingOnRefresh) {
        ...
        self.update = function(reset, recordVelocity, forceFake) {
            ...
            var scroll = $375cdd9a1f4cd44d$var$_refreshingAll === true ? prevScroll : self.scroll(), p = reset ? 0 : (scroll - start) / change, clipped = p < 0 ? 0 : p > 1 ? 1 : p || 0, prevProgress = self.progress, isActive, wasActive, toggleState, action, stateChanged, toggled, isAtMax, isTakingAction;
            if (recordVelocity) {
                scroll2 = scroll1;
            ...
            if (anticipatePin && pin && !$375cdd9a1f4cd44d$var$_refreshing && !$375cdd9a1f4cd44d$var$_startup && $375cdd9a1f4cd44d$var$_lastScrollTime) {
                if (!clipped && start < scroll + (scroll - scroll2) / ($375cdd9a1f4cd44d$var$_getTime() - $375cdd9a1f4cd44d$var$_time2) * anticipatePin) clipped = 0.0001;
                else if (clipped === 1 && end > scroll + (scroll - scroll2) / ($375cdd9a1f4cd44d$var$_getTime() - $375cdd9a1f4cd44d$var$_time2) * anticipatePin) clipped = 0.9999;
            }
            if (clipped !== prevProgress && self.enabled) {
                ...
                if (!isToggle) {
                    ...
                    } else if (animation) animation.totalProgress(clipped, !!($375cdd9a1f4cd44d$var$_refreshing && (lastRefresh || reset)));
                }
                if (pin) {
                    ...
                    if (!useFixedPosition) pinSetter($375cdd9a1f4cd44d$var$_round(pinStart + pinChange * clipped));
                        ...
                        if (pinReparent) {
                            if (!reset && (isActive || isAtMax)) {
                                ...
                                $375cdd9a1f4cd44d$var$_reparent(pin, $375cdd9a1f4cd44d$var$_body, bounds.top + (direction === (0, $1i8wn._vertical) ? _offset : 0) + $375cdd9a1f4cd44d$var$_px, bounds.left + (direction === (0, $1i8wn._vertical) ? 0 : _offset) + $375cdd9a1f4cd44d$var$_px);
        ...
        self.enable = function(reset, refresh) {
            if (!self.enabled) {
                ...
                isViewport || $375cdd9a1f4cd44d$var$_addListener(scroller, "scroll", $375cdd9a1f4cd44d$var$_onScroll);
        ...
        self.setPositions = function(newStart, newEnd, keepClamp, pinOffset) {
            ...
            self.refresh(false, false, {
                start: $375cdd9a1f4cd44d$var$_keepClamp(newStart, keepClamp && !!self._startClamp),
                end: $375cdd9a1f4cd44d$var$_keepClamp(newEnd, keepClamp && !!self._endClamp)
            }, pinOffset);
            self.update();
        };
        ...
        self.disable = function(reset, allowAnimation) {
            if (self.enabled) {
                ...
                if (!isViewport) {
                    ...
                    isViewport || $375cdd9a1f4cd44d$var$_removeListener(scroller, "scroll", $375cdd9a1f4cd44d$var$_onScroll);
                }
            }
        };
        ...
        if (animation && animation.add && !change) {
            ...
            $375cdd9a1f4cd44d$var$gsap.delayedCall(0.01, self.update);
            change = 0.01;
            start = end = 0;
        } else self.refresh();
    ...
    ScrollTrigger.disable = function disable(reset, kill) {
        ...
        for(var i = 0; i < (0, $1i8wn._scrollers).length; i += 3){
            $375cdd9a1f4cd44d$var$_wheelListener($375cdd9a1f4cd44d$var$_removeListener, (0, $1i8wn._scrollers)[i], (0, $1i8wn._scrollers)[i + 1]);
            $375cdd9a1f4cd44d$var$_wheelListener($375cdd9a1f4cd44d$var$_removeListener, (0, $1i8wn._scrollers)[i], (0, $1i8wn._scrollers)[i + 2]);
        }
    };
    ScrollTrigger.enable = function enable() {
        ...
        if ($375cdd9a1f4cd44d$var$gsap) {
            ...
            $375cdd9a1f4cd44d$var$_lastScroll = $375cdd9a1f4cd44d$var$_win.pageYOffset;
            ...
            if ($375cdd9a1f4cd44d$var$_body) {
                ...
                $375cdd9a1f4cd44d$var$_div100vh = document.createElement("div"); // to solve mobile browser address bar show/hide resizing, we shouldn't rely on window.innerHeight. Instead, use a <div> with its height set to 100vh and measure that since that's what the scrolling is based on anyway and it's not affected by address bar showing/hiding.
                $375cdd9a1f4cd44d$var$_div100vh.style.height = "100vh";
                $375cdd9a1f4cd44d$var$_div100vh.style.position = "absolute";
                $375cdd9a1f4cd44d$var$_refresh100vh();
                $375cdd9a1f4cd44d$var$_rafBugFix();
                (0, $1i8wn.Observer).register($375cdd9a1f4cd44d$var$gsap); // isTouch is 0 if no touch, 1 if ONLY touch, and 2 if it can accommodate touch but also other types like mouse/pointer.
                ScrollTrigger.isTouch = (0, $1i8wn.Observer).isTouch;
                $375cdd9a1f4cd44d$var$_fixIOSBug = (0, $1i8wn.Observer).isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent); // since 2017, iOS has had a bug that causes event.clientX/Y to be inaccurate when a scroll occurs, thus we must alternate ignoring every other touchmove event to work around it. See https://bugs.webkit.org/show_bug.cgi?id=181954 and https://codepen.io/GreenSock/pen/ExbrPNa/087cef197dc35445a0951e8935c41503
                $375cdd9a1f4cd44d$var$_ignoreMobileResize = (0, $1i8wn.Observer).isTouch === 1;
                ...
                (0, $1i8wn._vertical).m = Math.round(bounds.top + (0, $1i8wn._vertical).sc()) || 0; // accommodate the offset of the <body> caused by margins and/or padding
                (0, $1i8wn._horizontal).m = Math.round(bounds.left + (0, $1i8wn._horizontal).sc()) || 0;
                ...
                $375cdd9a1f4cd44d$var$_addListener($375cdd9a1f4cd44d$var$_body, "touchstart", $375cdd9a1f4cd44d$var$_passThrough); //works around Safari bug: https://gsap.com/forums/topic/21450-draggable-in-iframe-on-mobile-is-buggy/
                ...
                for(i = 0; i < (0, $1i8wn._scrollers).length; i += 3){
                    $375cdd9a1f4cd44d$var$_wheelListener($375cdd9a1f4cd44d$var$_removeListener, (0, $1i8wn._scrollers)[i], (0, $1i8wn._scrollers)[i + 1]);
                    $375cdd9a1f4cd44d$var$_wheelListener($375cdd9a1f4cd44d$var$_removeListener, (0, $1i8wn._scrollers)[i], (0, $1i8wn._scrollers)[i + 2]);
                }
            }
    ...
    ScrollTrigger.scrollerProxy = function scrollerProxy(target, vars) {
        var t = (0, $1i8wn._getTarget)(target), i = (0, $1i8wn._scrollers).indexOf(t), isViewport = $375cdd9a1f4cd44d$var$_isViewport(t);
        if (~i) (0, $1i8wn._scrollers).splice(i, isViewport ? 6 : 2);
        if (vars) isViewport ? (0, $1i8wn._proxies).unshift($375cdd9a1f4cd44d$var$_win, vars, $375cdd9a1f4cd44d$var$_body, vars, $375cdd9a1f4cd44d$var$_docEl, vars) : (0, $1i8wn._proxies).unshift(t, vars);
    };
    ...
    ScrollTrigger.isInViewport = function isInViewport(element, ratio, horizontal) {
        var bounds = ($375cdd9a1f4cd44d$var$_isString(element) ? (0, $1i8wn._getTarget)(element) : element).getBoundingClientRect(), offset = bounds[horizontal ? $375cdd9a1f4cd44d$var$_width : $375cdd9a1f4cd44d$var$_height] * ratio || 0;
    ...
    ScrollTrigger.positionInViewport = function positionInViewport(element, referencePoint, horizontal) {
        $375cdd9a1f4cd44d$var$_isString(element) && (element = (0, $1i8wn._getTarget)(element));
...
$375cdd9a1f4cd44d$export$875bcbe48555930.version = "3.12.5";
...
$375cdd9a1f4cd44d$export$875bcbe48555930.update = function(force) {
    return ++(0, $1i8wn._scrollers).cache && $375cdd9a1f4cd44d$var$_updateAll(force === true ? 2 : 0);
};
...
$375cdd9a1f4cd44d$export$875bcbe48555930.maxScroll = function(element, horizontal) {
    return $375cdd9a1f4cd44d$var$_maxScroll(element, horizontal ? (0, $1i8wn._horizontal) : (0, $1i8wn._vertical));
};
$375cdd9a1f4cd44d$export$875bcbe48555930.getScrollFunc = function(element, horizontal) {
    return (0, $1i8wn._getScrollFunc)((0, $1i8wn._getTarget)(element), horizontal ? (0, $1i8wn._horizontal) : (0, $1i8wn._vertical));
};
...
var $375cdd9a1f4cd44d$var$_clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier(scrollFunc, current, end, max) {
    ...
    else target.style.touchAction = direction === true ? "auto" : direction ? "pan-" + direction + ((0, $1i8wn.Observer).isTouch ? " pinch-zoom" : "") : "none"; // note: Firefox doesn't support it pinch-zoom properly, at least in addition to a pan-x or pan-y.
    ...
    if (!cache._isScrollT || time - cache._isScrollT > 2000) {
        ...
        while(node && node !== $375cdd9a1f4cd44d$var$_body && (node.scrollHeight <= node.clientHeight && node.scrollWidth <= node.clientWidth || !($375cdd9a1f4cd44d$var$_overflow[(cs = $375cdd9a1f4cd44d$var$_getComputedStyle(node)).overflowY] || $375cdd9a1f4cd44d$var$_overflow[cs.overflowX])))node = node.parentNode;
        cache._isScroll = node && node !== target && !$375cdd9a1f4cd44d$var$_isViewport(node) && ($375cdd9a1f4cd44d$var$_overflow[(cs = $375cdd9a1f4cd44d$var$_getComputedStyle(node)).overflowY] || $375cdd9a1f4cd44d$var$_overflow[cs.overflowX]);
...
$375cdd9a1f4cd44d$var$_inputObserver = function _inputObserver(target, type, inputs, nested) {
    return (0, $1i8wn.Observer).create({
        target: target,
        capture: true,
        debounce: false,
        lockAxis: true,
        ...
        onEnable: function onEnable() {
            return inputs && $375cdd9a1f4cd44d$var$_addListener($375cdd9a1f4cd44d$var$_doc, (0, $1i8wn.Observer).eventTypes[0], $375cdd9a1f4cd44d$var$_captureInputs, false, true);
        },
        onDisable: function onDisable() {
            return $375cdd9a1f4cd44d$var$_removeListener($375cdd9a1f4cd44d$var$_doc, (0, $1i8wn.Observer).eventTypes[0], $375cdd9a1f4cd44d$var$_captureInputs, true);
        }
    });
    ...
    var _vars2 = vars, normalizeScrollX = _vars2.normalizeScrollX, momentum = _vars2.momentum, allowNestedScroll = _vars2.allowNestedScroll, onRelease = _vars2.onRelease, self, maxY, target = (0, $1i8wn._getTarget)(vars.target) || $375cdd9a1f4cd44d$var$_docEl, smoother = $375cdd9a1f4cd44d$var$gsap.core.globals().ScrollSmoother, smootherInstance = smoother && smoother.get(), content = $375cdd9a1f4cd44d$var$_fixIOSBug && (vars.content && (0, $1i8wn._getTarget)(vars.content) || smootherInstance && vars.content !== false && !smootherInstance.smooth() && smootherInstance.content()), scrollFuncY = (0, $1i8wn._getScrollFunc)(target, (0, $1i8wn._vertical)), scrollFuncX = (0, $1i8wn._getScrollFunc)(target, (0, $1i8wn._horizontal)), scale = 1, initialScale = ((0, $1i8wn.Observer).isTouch && $375cdd9a1f4cd44d$var$_win.visualViewport ? $375cdd9a1f4cd44d$var$_win.visualViewport.scale * $375cdd9a1f4cd44d$var$_win.visualViewport.width : $375cdd9a1f4cd44d$var$_win.outerWidth) / $375cdd9a1f4cd44d$var$_win.innerWidth, wheelRefresh = 0, resolveMomentumDuration = $375cdd9a1f4cd44d$var$_isFunction(momentum) ? function() {
        ...
        maxY = $375cdd9a1f4cd44d$var$_maxScroll(target, (0, $1i8wn._vertical));
        scrollClampY = $375cdd9a1f4cd44d$var$_clamp($375cdd9a1f4cd44d$var$_fixIOSBug ? 1 : 0, maxY);
        normalizeScrollX && (scrollClampX = $375cdd9a1f4cd44d$var$_clamp(0, $375cdd9a1f4cd44d$var$_maxScroll(target, (0, $1i8wn._horizontal))));
        ...
        if (skipTouchMove) {
            ...
            if (content && scroll !== scrollFuncY.v + scrollFuncY.offset) {
                ...
                scrollFuncY.cacheID = (0, $1i8wn._scrollers).cache;
    ...
    vars.onRelease = vars.onGestureStart = function(self, wasDragging) {
        ...
        if (!wasDragging) onStopDelayedCall.restart(true);
            ...
            (0, $1i8wn._scrollers).cache++; // make sure we're pulling the non-cached value
            // alternate algorithm: durX = Math.min(6, Math.abs(self.velocityX / 800)),	dur = Math.max(durX, Math.min(6, Math.abs(self.velocityY / 800))); dur = dur * (0.4 + (1 - _power4In(dur / 6)) * 0.6)) * (momentumSpeed || 1)
            var dur = resolveMomentumDuration(), currentScroll, endScroll;
            if (normalizeScrollX) {
                currentScroll = scrollFuncX();
                endScroll = currentScroll + dur * 0.05 * -self.velocityX / 0.227; // the constant .227 is from power4(0.05). velocity is inverted because scrolling goes in the opposite direction.
                dur *= $375cdd9a1f4cd44d$var$_clampScrollAndGetDurationMultiplier(scrollFuncX, currentScroll, endScroll, $375cdd9a1f4cd44d$var$_maxScroll(target, (0, $1i8wn._horizontal)));
                tween.vars.scrollX = scrollClampX(endScroll);
            }
            currentScroll = scrollFuncY();
            endScroll = currentScroll + dur * 0.05 * -self.velocityY / 0.227; // the constant .227 is from power4(0.05)
            dur *= $375cdd9a1f4cd44d$var$_clampScrollAndGetDurationMultiplier(scrollFuncY, currentScroll, endScroll, $375cdd9a1f4cd44d$var$_maxScroll(target, (0, $1i8wn._vertical)));
    ...
    self = new (0, $1i8wn.Observer)(vars);
    ...
    tween = $375cdd9a1f4cd44d$var$gsap.to(self, {
        ...
        scrollY: "+=0.1",
        modifiers: {
            scrollY: $375cdd9a1f4cd44d$var$_interruptionTracker(scrollFuncY, scrollFuncY(), function() {
                return tween.pause();
            })
        },
        onUpdate: $375cdd9a1f4cd44d$var$_updateAll,
...
$375cdd9a1f4cd44d$export$875bcbe48555930.observe = function(vars) {
    return new (0, $1i8wn.Observer)(vars);
};
$375cdd9a1f4cd44d$export$875bcbe48555930.normalizeScroll = function(vars) {
    ...
    if (vars === false) {
        $375cdd9a1f4cd44d$var$_normalizer && $375cdd9a1f4cd44d$var$_normalizer.kill();
        $375cdd9a1f4cd44d$var$_normalizer = vars;
        return;
    }
    var normalizer = vars instanceof (0, $1i8wn.Observer) ? vars : $375cdd9a1f4cd44d$var$_getScrollNormalizer(vars);
...
$375cdd9a1f4cd44d$export$875bcbe48555930.core = {
    ...
    _getVelocityProp: (0, $1i8wn._getVelocityProp),
    _inputObserver: $375cdd9a1f4cd44d$var$_inputObserver,
    _scrollers: (0, $1i8wn._scrollers),
    _proxies: (0, $1i8wn._proxies),
    bridge: {
...
parcelRegister("1i8wn", function(module, exports) {

$parcel$export(module.exports, "_scrollers", () => $0f0e1503ed2c844e$export$3cd1cee43d19b683);
$parcel$export(module.exports, "_proxies", () => $0f0e1503ed2c844e$export$d8e56d510a804d0a);
$parcel$export(module.exports, "_getProxyProp", () => $0f0e1503ed2c844e$export$6078f1ef08b38af9);
$parcel$export(module.exports, "_horizontal", () => $0f0e1503ed2c844e$export$b2cabb342cb0ebe1);
$parcel$export(module.exports, "_vertical", () => $0f0e1503ed2c844e$export$8e40fc98ff518e9d);
$parcel$export(module.exports, "_getTarget", () => $0f0e1503ed2c844e$export$937374fea3f88711);
$parcel$export(module.exports, "_getScrollFunc", () => $0f0e1503ed2c844e$export$8665aac53dad5647);
$parcel$export(module.exports, "_getVelocityProp", () => $0f0e1503ed2c844e$export$5de019f4480f0f8d);
$parcel$export(module.exports, "Observer", () => $0f0e1503ed2c844e$export$c1cbdee04e18ea8b);
function $0f0e1503ed2c844e$var$_defineProperties(target, props) {
...
*/ /* eslint-disable */ var $0f0e1503ed2c844e$var$gsap, $0f0e1503ed2c844e$var$_coreInitted, $0f0e1503ed2c844e$var$_clamp, $0f0e1503ed2c844e$var$_win, $0f0e1503ed2c844e$var$_doc, $0f0e1503ed2c844e$var$_docEl, $0f0e1503ed2c844e$var$_body, $0f0e1503ed2c844e$var$_isTouch, $0f0e1503ed2c844e$var$_pointerType, $0f0e1503ed2c844e$var$ScrollTrigger, $0f0e1503ed2c844e$var$_root, $0f0e1503ed2c844e$var$_normalizer, $0f0e1503ed2c844e$var$_eventTypes, $0f0e1503ed2c844e$var$_context, $0f0e1503ed2c844e$var$_getGSAP = function _getGSAP() {
...
}, $0f0e1503ed2c844e$var$_addListener = function _addListener(element, type, func, passive, capture) {
    return element.addEventListener(type, func, {
...
}, $0f0e1503ed2c844e$export$937374fea3f88711 = function _getTarget(t, self) {
    return (self && self._ctx && self._ctx.selector || $0f0e1503ed2c844e$var$gsap.utils.toArray)(t)[0] || (typeof t === "string" && $0f0e1503ed2c844e$var$gsap.config().nullTargetWarn !== false ? console.warn("Element not found:", t) : null);
    ...
    $0f0e1503ed2c844e$export$3cd1cee43d19b683[i + offset] || $0f0e1503ed2c844e$var$_addListener(element, "scroll", $0f0e1503ed2c844e$var$_onScroll); // clear the cache when a scroll occurs
    ...
    if (!$0f0e1503ed2c844e$var$_coreInitted && $0f0e1503ed2c844e$var$gsap && typeof document !== "undefined" && document.body) {
        ...
        $0f0e1503ed2c844e$var$_context = $0f0e1503ed2c844e$var$gsap.core.context || function() {};
...
var $0f0e1503ed2c844e$export$c1cbdee04e18ea8b = /*#__PURE__*/ function() {
    ...
    _proto.init = function init(vars) {
        ...
        var id, onStopDelayedCall, dragged, moved, wheeled, locked, axis, self = this, prevDeltaX = 0, prevDeltaY = 0, passive = vars.passive || !preventDefault, scrollFuncX = $0f0e1503ed2c844e$export$8665aac53dad5647(target, $0f0e1503ed2c844e$export$b2cabb342cb0ebe1), scrollFuncY = $0f0e1503ed2c844e$export$8665aac53dad5647(target, $0f0e1503ed2c844e$export$8e40fc98ff518e9d), scrollX = scrollFuncX(), scrollY = scrollFuncY(), limitToTouch = ~type.indexOf("touch") && !~type.indexOf("pointer") && $0f0e1503ed2c844e$var$_eventTypes[0] === "pointerdown", // for devices that accommodate mouse events and touch events, we need to distinguish.
        ...
        deltaY = [
            ...
            self._vy.reset();
            $0f0e1503ed2c844e$var$_addListener(isNormalizer ? target : ownerDoc, $0f0e1503ed2c844e$var$_eventTypes[1], _onDrag, passive, true);
        ...
        self.isDragging = self.isGesturing = self.isPressed = false;
        $0f0e1503ed2c844e$var$_context(this);
        self.enable = function(e) {
            if (!self.isEnabled) {
                $0f0e1503ed2c844e$var$_addListener(isViewport ? ownerDoc : target, "scroll", $0f0e1503ed2c844e$var$_onScroll);
                type.indexOf("scroll") >= 0 && $0f0e1503ed2c844e$var$_addListener(isViewport ? ownerDoc : target, "scroll", onScroll, passive, capture);
                type.indexOf("wheel") >= 0 && $0f0e1503ed2c844e$var$_addListener(target, "wheel", _onWheel, passive, capture);
                if (type.indexOf("touch") >= 0 && $0f0e1503ed2c844e$var$_isTouch || type.indexOf("pointer") >= 0) {
                    $0f0e1503ed2c844e$var$_addListener(target, $0f0e1503ed2c844e$var$_eventTypes[0], _onPress, passive, capture);
                    ...
                    allowClicks && $0f0e1503ed2c844e$var$_addListener(target, "click", clickCapture, true, true);
...
$0f0e1503ed2c844e$export$c1cbdee04e18ea8b.version = "3.12.5";
